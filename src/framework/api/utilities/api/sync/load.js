 ...
 * 
 * @name api_sync_loader
 * @access this.api.utilities.api.sync.load
 * @type {Function}
 * @async false
 ...
 * @returns {Object} base | El objeto inicial llenado con la API
 * 
 */
const api_sync_loader = function (directory, base, property_id, root_parameter = undefined, property_tracker = []) {
    try {
        ...
        for (let index = 0; index < files.length; index++) {
            ...
            Caso_de_carpeta: {
                if (isDirectory) {
                    ...
                    api_sync_loader(filepath, base[property_id], subproperty_id, root_parameter, property_tracker.concat([]));
        ...
        console.error("Error in «api_sync_loader»", error);
    }
};
module.exports = api_sync_loader;