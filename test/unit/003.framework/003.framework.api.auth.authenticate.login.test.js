module.exports = async function () {
    try {
        ...
        Testear_funcion: {
            const authentication_data_for_user_1 = await this.framework_all.api.auth.authenticate.login("dummy_user_1", "dummy_user_1");
            const authentication_data_for_user_2 = await this.framework_all.api.auth.authenticate.login("dummy_user_2", "dummy_user_2");
            require("assert").deepStrictEqual(authentication_data_for_user_2, {
                session: {
                    token: 'un.token.dummy.2',
                    user: 'dummy_user_2'
                },
                ...
                permissions: [{
                    name: 'dummy_permission_7',
                    description: 'dummy_permission_7',
                    _id: 'dummy_permission_7'
                }]
            });
            require("assert").deepStrictEqual(authentication_data_for_user_1, {
                session: {
                    token: 'un.token.dummy',
                    user: 'dummy_user_1'
                },
